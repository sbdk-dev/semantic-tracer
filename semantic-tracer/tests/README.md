# Semantic Tracer Test Suite

This directory contains the complete testing infrastructure for the Semantic Tracer application.
...
│   └── dbtSemanticLayer.ts      # dbt semantic layer fixtures
│
├── unit/                        # Unit tests for individual modules
│   └── services/
│       ├── lineage.test.ts      # Lineage graph generation tests
│       └── snowflake.test.ts    # Snowflake query service tests
│
├── integration/                 # Integration tests for component interactions
│   └── LineageCanvas.test.tsx   # React Flow integration tests
│
└── e2e/                         # End-to-end tests for user workflows
    └── lineage-exploration.spec.ts # Complete user workflows
```
...
**Purpose:** To test individual functions and services in isolation.

**Location:** `tests/unit/`

### Integration Tests

**Purpose:** To test the interaction between different components, particularly the integration with the React Flow canvas.

**Location:** `tests/integration/`

### End-to-End Tests

**Purpose:** To test complete user workflows from start to finish.
