# Semantic Tracer Test Strategy

## Overview

This document outlines the comprehensive testing strategy for the Semantic Tracer application. The strategy ensures high test coverage and validates the core functionality of the local-first semantic layer.
...
### Test Distribution
- **Unit Tests:** ~70% of the test suite. Fast, focused, and isolated.
- **Integration Tests:** ~25% of the test suite. Test interactions between components.
- **E2E Tests:** ~5% of the test suite. Test critical user flows.
...
2.  **dbt Semantic Layer Integration**:
    *   Parsing dbt semantic models.
    *   Handling errors in the semantic models.

3.  **Snowflake Integration**:
    *   Querying Snowflake for metadata.
    *   Handling connection errors.

4.  **React Flow Operations**:
    *   Node and edge creation.
    *   Automatic layout of the lineage graph.
...
-   **Purpose**: Test component interactions, especially with the React Flow canvas.
